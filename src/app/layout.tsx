...
export const metadata: Metadata = {
  ...
  title: {
    default: "NeoFidu | Swiss Tax Returns & Accounting",
    template: "%s | NeoFidu",
  },
  description:
    "Swiss tax returns from your smartphone. Digital fiduciary from CHF 50. Service for Vaud, Geneva, Valais. We speak English!",
  ...
  keywords: [
    // English keywords for expats and international workers
    "swiss tax return",
    "switzerland tax filing",
    "swiss tax advisor",
    "expat tax switzerland",
    "swiss tax accountant",
    "tax return switzerland online",
    "swiss tax declaration",
    "file taxes switzerland",
    "swiss tax help",
    "switzerland tax service",
    "geneva tax return",
    "lausanne tax advisor",
    "vaud tax filing",
    "valais tax service",
    "swiss tax for foreigners",
    "expat taxes switzerland",
    "international tax switzerland",
    "swiss tax consultant",
    "online tax filing switzerland",
    "swiss tax return english",
    // Expat-specific keywords
    "expat tax help switzerland",
    ...
    "tax deductions expats switzerland",
    // French keywords
    "fiduciaire suisse",
    ...
    "fiduciaire Monthey",
    "comptable Monthey",
    "déclaration impôts Monthey",
    "fiduciaire Chablais valaisan",
    "fiduciaire Troistorrents",
    "comptable Champéry",
    "fiduciaire Val-d'Illiez",
    "impôts St-Maurice",
  ],
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous pouvez nous contacter par email à contact@neofidu.ch, par téléphone au +41 78 691 39 12, ou via notre formulaire de contact en ligne. Réponse garantie sous 24h ouvrées.",
        },
      },
    ],
  };

...
(161 caractères — dans la plage 150-220, et sans caractère spécial)

Note : assure-toi de taper CHF 50 avec un espace normal (pas copier-coller depuis un PDF ou Word).

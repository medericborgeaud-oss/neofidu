...
// FAQ data in both languages for JSON-LD schema
const faqItemsFR: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Vous nous adressez vos justificatifs (factures, relevés) selon une cadence mensuelle ou annuelle. Nous enregistrons les opérations, produisons les déclarations requises et vous transmettons un état de situation régulier."
  },
  {
    category: "Gestion comptable",
  ...
  },
  {
    ...
    answer: "Pour la comptabilité, une facturation mensuelle ou annuelle est prévue (avec remise de 10 % sur l'option annuelle). Les prestations fiscales ponctuelles se règlent en une seule fois."
  },
...
const faqItemsEN: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "For accounting, monthly or annual billing is available (with a 10% discount on the annual option). One-time tax services are paid in a single payment."
  },
  // General Information
  {
...
export default function FAQPage() {
  ...
  // Generate schema for current language
    ...
    <main className="min-h-screen bg-gradient-to-b from-secondary/30 to-white">
      ...
      <div className="pt-28 pb-20">
        <div className="container mx-auto px-4">
          ...
          {/* FAQ Items - Using native details/summary for SEO-friendly accordions */}
          <div className="max-w-3xl mx-auto space-y-4">
            {filteredFAQ.map((item, index) => (
              ...
              >
                {/* Using itemscope for additional SEO markup */}
                <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <h2 className="font-semibold text-lg" itemProp="name">{item.question}</h2>
                    </div>
                  ...
                  {/* Answer - ALWAYS in DOM, use CSS grid for smooth animation */}
                  <div
                    id={`faq-answer-${index}`}
                    itemScope
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link href="/blog/declaration-impots-2025-guide-complet" className="group">
                <Card className="p-5 h-full hover:shadow-lg hover:border-primary/20 transition-all">
                  ...
                  <h3 className="font-semibold mt-2 group-hover:text-primary transition-colors">
                    {isEnglish ? "2025 Tax Return: Complete Guide" : "Déclaration d'impôts 2025 : guide complet"}
                  </h3>

...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Standard processing takes 14 business days. Need it faster? Choose Priority (7 days, +CHF 30). Once completed, you'll receive your tax return by email, ready to submit to the tax authorities.",
      },
    },
    {
      "@type": "Question",

...
export const metadata: Metadata = {
  title: "Simulateur d'Impôts Suisse 2025 | Calcul Gratuit | NeoFidu",
  description:
    "Calculez vos impôts en Suisse romande gratuitement. Simulateur fiscal pour Vaud, Genève, Valais, Fribourg, Neuchâtel et Jura. Estimation instantanée et précise.",
  keywords:
    "simulateur impôts suisse, calculateur impôts vaud, simulation fiscale genève, calcul impôts valais, estimation impôts suisse romande, calculette impôts 2025",
  openGraph: {
    title: "Simulateur d'Impôts Suisse 2025 | Calcul Gratuit",
    description:
      "Calculez vos impôts en Suisse romande gratuitement. Estimation instantanée pour les 6 cantons romands.",
    type: "website",
  },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Les principales optimisations incluent : cotiser au 3ème pilier (jusqu'à CHF 7'056), effectuer des rachats LPP, déclarer tous les frais professionnels, et ne pas oublier les frais médicaux dépassant 5% du revenu.",
  },
];
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <h1 className="text-3xl md:text-5xl font-bold mb-4">
                  Simulateur d'Impôts
                  <br />
                  <span className="text-emerald-300">Suisse Romande 2025</span>
                </h1>

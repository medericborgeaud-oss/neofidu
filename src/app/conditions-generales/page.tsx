...
import { ArrowLeft, FileText, Shield, Scale, AlertCircle, CreditCard, Lock, Mail } from "lucide-react";
...
const sections = [
  {
    ...
    icon: FileText,
    content: `
      <p>Les présentes Conditions Générales (ci-après "CG") régissent l'ensemble des relations contractuelles entre NeoFidu SA (ci-après "NeoFidu"), société inscrite au Registre du Commerce du Canton de Vaud, et ses clients (ci-après "le Client").</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Les prestations comptables incluent la tenue des livres, l'établissement des bilans et comptes de résultat, les déclarations TVA et la gestion des salaires selon le forfait choisi par le Client.</p>
      ...
      <h4>2.4 Délais de traitement</h4>
      <p>Les délais annoncés sont indicatifs et dépendent de la complexité du dossier ainsi que de la réactivité du Client dans la transmission des documents requis. NeoFidu s'engage à informer le Client de tout retard prévisible.</p>
    `,
  },
  {
  ...
  {
    id: "confidentialite",
    title: "6. Confidentialité et protection des données",
    icon: Lock,
    content: `
      <h4>6.1 Secret professionnel</h4>
      ...
      <h4>6.2 Protection des données personnelles</h4>
      ...
      <h4>6.3 Finalités du traitement</h4>
      ...
      <h4>6.4 Conservation des données</h4>
  ...
  },
  {
    ...
    icon: FileText,
    content: `
      <h4>7.1 Prestations ponctuelles</h4>
      ...
      <h4>7.2 Prestations récurrentes</h4>
      ...
      <h4>7.3 Résiliation pour justes motifs</h4>
      ...
      <h4>7.4 Effets de la résiliation</h4>
  ...
  {
    id: "droit-applicable",
    title: "8. Droit applicable et for juridique",
    icon: Scale,
    content: `
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              Les présentes conditions régissent l'utilisation des services proposés par NeoFidu SA.
            </p>
          </motion.div>

...
export const metadata: Metadata = {
  title: "Guide des Déductions Fiscales 2025 | Suisse Romande | NeoFidu",
  description:
    ...
    items: [
      {
        ...
        federal: "CHF 7'056/an",
        vaud: "CHF 7'056/an",
        geneve: "CHF 7'056/an",
        valais: "CHF 7'056/an",
        fribourg: "CHF 7'056/an",
        neuchatel: "CHF 7'056/an",
        jura: "CHF 7'056/an",
...
const optimizationTips = [
  {
    ...
    description:
      "C'est la déduction la plus avantageuse. CHF 7'056 économisent environ CHF 2'000-2'500 d'impôts selon votre taux marginal.",
    icon: PiggyBank,
  },
  {
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl">
              <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-medium">Guide complet 2025</span>
              </div>

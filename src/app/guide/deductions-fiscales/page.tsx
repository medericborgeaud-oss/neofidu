...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Déductions fiscales en Suisse 2026 — Guide complet pour payer moins d'impôts",
    description: "Découvrez toutes les déductions fiscales auxquelles vous avez droit : 3ème pilier, frais professionnels, dons, frais de garde… Guide 2026.",
    type: "website",
    url: "https://www.neofidu.ch/guide/deductions-fiscales",
  },
  twitter: {
    card: "summary_large_image",
    title: "Déductions fiscales en Suisse 2026 — Guide complet",
    description: "Toutes les déductions fiscales : 3ème pilier, frais professionnels, dons, frais de garde. Guide 2026 Suisse romande.",
  },
  alternates: {

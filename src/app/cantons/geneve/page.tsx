...
export const metadata: Metadata = {
  title: "Fiduciaire Genève | Déclaration d'impôts Canton de Genève 2026 - NeoFidu",
  description: "Fiduciaire spécialisée dans le canton de Genève. Déclaration d'impôts pour particuliers, frontaliers et entreprises. Statut quasi-résident, GeTax. Délai 31 mars 2026.",
  keywords: "fiduciaire genève, déclaration impôts genève, impôts frontalier genève, quasi-résident, GeTax, fiscalité genevoise 2026",
  openGraph: {
    title: "Fiduciaire Genève | Déclaration d'impôts & Frontaliers",
    description: "Experts en fiscalité genevoise. Particuliers, frontaliers, quasi-résidents. Tarifs transparents.",

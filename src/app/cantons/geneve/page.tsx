...
export default function GenevePage() {
  ...
  const services = [
    ...
    {
      icon: Globe,
      title: isEnglish ? "Cross-border workers" : "Frontaliers",
      description: isEnglish
        ? "Quasi-resident expertise, TOU and tax optimization for cross-border workers."
        : "Expertise quasi-résident, TOU et optimisation fiscale pour travailleurs frontaliers.",

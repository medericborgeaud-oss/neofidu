...
export const metadata: Metadata = {
  title: "Fiduciaire Vaud | Déclaration d'impôts Canton de Vaud 2026 - NeoFidu",
  description: "Fiduciaire spécialisée dans le canton de Vaud. Déclaration d'impôts pour particuliers et indépendants à Lausanne, Montreux, Nyon, Vevey. Délai 15 mars 2026. Tarifs dès 149 CHF.",
  keywords: "fiduciaire vaud, déclaration impôts vaud, impôts lausanne, fiscalité vaud, VaudTax, délai impôts vaud 2026",
  openGraph: {
    title: "Fiduciaire Vaud | Déclaration d'impôts Lausanne & Canton de Vaud",
    description: "Votre déclaration d'impôts vaudoise en toute sérénité. Tarifs transparents, experts locaux, respect des délais.",

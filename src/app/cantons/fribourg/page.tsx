...
export default function FribourgPage() {
  ...
  const services = [
    ...
    {
      icon: Baby,
      title: isEnglish ? "Families" : "Familles",
      description: isEnglish
        ? "Optimization of the generous family deductions in canton Fribourg."
        : "Optimisation des déductions familiales généreuses du canton de Fribourg.",
      price: isEnglish ? "From CHF 60.-" : "Dès CHF 60.-"
    },
    {
      icon: Building2,

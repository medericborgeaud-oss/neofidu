...
export const blogArticles: BlogArticle[] = [
  {
    id: "111",
    slug: "assurances-independant-suisse",
    title: "Débuter comme indépendant en Suisse : quelles assurances prendre (et dans quel ordre)",
    ...
    date: "2026-09-17",
    readTime: 7,
    keywords: ["assurances indépendant", "AVS indépendant", "3e pilier indépendant", "perte de gain", "RC professionnelle", "LAA accident", "prévoyance indépendant", "début activité indépendante Suisse"],

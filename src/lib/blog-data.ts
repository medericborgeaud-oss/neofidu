...
export const blogArticles: BlogArticle[] = [
  {
    id: "110",
    slug: "dividende-action-americaine-suisse",
    title: "Dividende d'une action américaine : ce qu'un résident suisse doit faire (et éviter)",
    titleEn: "Dividends from US Stocks: What a Swiss Resident Should Do (and Avoid)",
    excerpt: "Retenue américaine 30 % ou 15 %, formulaire W-8BEN, imposition en Suisse, récupération via le formulaire DA-1, et les pièges à éviter (impôt anticipé, US estate tax, domicile des ETF).",
    excerptEn: "US withholding of 30% or 15%, the W-8BEN form, Swiss taxation, recovery via the DA-1 form, and the traps to avoid (anticipatory tax, US estate tax, ETF domicile).",
    content: "<div style='max-width:820px;margin:0 auto;font-family:Calibri,Arial,sans-serif;color:#1F2937;line-height:1.6;font-size:17px'><p>Vous détenez des actions américaines (Apple, Microsoft, Coca-Cola) et vous touchez des dividendes. En tant que résident suisse, vous êtes imposé des deux côtés de l'Atlantique, mais la double imposition peut, pour l'essentiel, être neutralisée si vous faites les bons gestes. Voici la mécanique, et surtout ce qu'il faut faire ou ne pas faire.</p><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>1. Côté américain : 30 % ou 15 %</h2><p>Quand une société américaine verse un dividende à un non-résident, le fisc américain prélève une retenue à la source. Le taux de base est de <strong>30 %</strong>. Grâce à la convention de double imposition entre la Suisse et les États-Unis, un résident suisse a droit à un taux réduit de <strong>15 %</strong> sur les dividendes de portefeuille.</p><p>La condition est simple mais essentielle : avoir déposé un <strong>formulaire W-8BEN</strong> auprès de votre banque ou courtier. Il atteste votre résidence fiscale suisse et déclenche le taux de 15 %. Il est valable <strong>trois ans</strong>. Sans W-8BEN valide, la banque applique 30 %, et vous perdez la moitié de la retenue.</p><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>2. Côté suisse : c'est un revenu imposable</h2><p>Le dividende américain est un <strong>revenu de la fortune mobilière</strong>. Vous devez le déclarer, à sa valeur <strong>brute</strong> (avant retenue), et il s'ajoute à vos autres revenus pour être imposé à votre taux ordinaire.</p><p>Attention à une confusion fréquente : l'<strong>impôt anticipé suisse de 35 %</strong> ne s'applique <strong>pas</strong> ici. Il ne concerne que les dividendes de source suisse. Sur une action américaine, il n'y a pas d'impôt anticipé suisse, seulement la retenue américaine.</p><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>3. Récupérer les 15 % : l'imputation forfaitaire (DA-1)</h2><p>La convention prévoit que les 15 % retenus aux États-Unis viennent en déduction de votre impôt suisse. Cela passe par l'<strong>imputation forfaitaire d'impôt</strong>, réclamée via le <strong>formulaire DA-1</strong> joint à votre déclaration. L'État vous crédite les 15 % déjà payés à l'étranger contre l'impôt suisse dû sur ce revenu.</p><p>Deux points pratiques : un <strong>montant minimal de 100 CHF</strong> par an de retenues étrangères non récupérables est requis pour obtenir l'imputation (en dessous, pas de crédit) ; et les banques suisses fournissent un <strong>relevé fiscal</strong> qui pré-calcule les montants du DA-1. Pour les titres américains, une <strong>retenue supplémentaire d'impôt USA</strong> parfois prélevée est, elle, remboursée en Suisse via la déclaration. Au final, avec un W-8BEN et un DA-1 corrects, vous ne supportez que l'impôt suisse sur le revenu.</p><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>Ce qu'il faut FAIRE</h2><div style='background:#F0FDF9;border:1px solid #10B981;border-radius:8px;padding:12px 16px;margin:12px 0'><ul><li><strong>Déposer le W-8BEN</strong> auprès de votre banque pour passer de 30 % à 15 %, et le renouveler tous les trois ans.</li><li><strong>Déclarer le dividende brut</strong> et vos titres dans l'état des titres.</li><li><strong>Remplir le formulaire DA-1</strong> pour récupérer les 15 % par imputation forfaitaire.</li><li><strong>Conserver le relevé fiscal</strong> de la banque, qui justifie et pré-remplit vos montants.</li><li><strong>Regrouper vos titres étrangers</strong> pour dépasser le seuil de 100 CHF.</li></ul></div><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>Ce qu'il ne faut PAS faire</h2><div style='background:#FEF2F2;border:1px solid #FCA5A5;border-radius:8px;padding:12px 16px;margin:12px 0'><ul><li><strong>Oublier le W-8BEN.</strong> Résultat : 30 % retenus, dont seulement 15 % récupérables en Suisse. L'autre moitié ne se réclame qu'auprès de l'IRS américain, démarche lourde et rarement rentable.</li><li><strong>Ne pas déclarer le dividende.</strong> C'est de la soustraction d'impôt (rappels, amende, intérêts), et vous perdez l'imputation.</li><li><strong>Croire que l'impôt anticipé de 35 % s'applique</strong> ou sera remboursé : non, il n'existe pas sur les titres étrangers.</li><li><strong>Ignorer l'impôt successoral américain (US estate tax).</strong> Les actions américaines détenues en direct sont des biens situés aux États-Unis : au décès d'un non-résident, la part au-delà d'environ <strong>60 000 USD</strong> peut être taxée jusqu'à 40 %. La convention successorale CH-USA atténue, mais l'exposition est réelle sur les gros portefeuilles.</li><li><strong>Détenir des ETF américains sans réfléchir au domicile du fonds.</strong> Un <strong>ETF domicilié en Irlande</strong> (UCITS) est souvent plus efficient pour un investisseur suisse en actions américaines : taux de 15 % au niveau du fonds et surtout pas d'exposition à l'impôt successoral américain.</li></ul></div><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>Un exemple chiffré</h2><p>Dividende brut : 1 000 USD. Avec W-8BEN, les États-Unis retiennent 150 USD (15 %), vous recevez 850 USD. En Suisse, vous déclarez 1 000 USD ; imposé à votre taux (disons 30 %), soit 300 USD d'impôt suisse théorique. Grâce au DA-1, vous imputez les 150 USD déjà payés, ramenant l'impôt suisse à 150 USD. Total supporté : 300 USD, soit exactement votre impôt suisse. Sans W-8BEN, 300 USD auraient été retenus aux États-Unis, dont 150 perdus.</p><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>En résumé</h2><p>Le dividende d'une action américaine n'est pas doublement taxé si vous suivez la mécanique : W-8BEN pour 15 %, déclaration du brut, et DA-1 pour récupérer ces 15 %. Les vrais pièges ne sont pas le taux, mais l'oubli du formulaire, la non-déclaration, et l'impôt successoral américain sur les titres en direct.</p><p style='background:#F0FDF9;border:1px solid #10B981;border-radius:8px;padding:14px 16px;margin-top:22px'>Chez <strong>NeoFidu</strong>, nous remplissons l'état des titres et le formulaire DA-1, vérifions vos retenues étrangères et optimisons la structure de vos placements (domicile des fonds, exposition successorale).</p><p style='font-size:13px;color:#6B7280;font-style:italic;margin-top:20px'>Information générale, ne constituant pas un conseil fiscal personnalisé. Les taux et pratiques évoluent selon votre situation.</p></div>",
    contentEn: "<div style='max-width:820px;margin:0 auto;font-family:Calibri,Arial,sans-serif;color:#1F2937;line-height:1.6;font-size:17px'><p>You hold US stocks (Apple, Microsoft, Coca-Cola) and receive dividends. As a Swiss resident you are taxed on both sides of the Atlantic, but the double taxation can largely be neutralised if you take the right steps. Here is how it works, and what to do or avoid.</p><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>1. The US side: 30% or 15%</h2><p>When a US company pays a dividend to a non-resident, the US levies a withholding tax. The default rate is <strong>30%</strong>. Under the Switzerland-US tax treaty, a Swiss resident is entitled to a reduced <strong>15%</strong> rate on portfolio dividends.</p><p>The key condition: having filed a <strong>W-8BEN form</strong> with your bank or broker. It certifies your Swiss tax residence and triggers the 15% rate. It is valid for <strong>three years</strong>. Without a valid W-8BEN, 30% is withheld and you lose half of it.</p><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>2. The Swiss side: it is taxable income</h2><p>The US dividend is <strong>investment income</strong>. You must declare it at its <strong>gross</strong> value (before withholding); it is added to your other income and taxed at your ordinary rate.</p><p>A common misconception: the Swiss <strong>35% anticipatory tax</strong> does <strong>not</strong> apply here. It only concerns Swiss-source dividends. On a US share there is no Swiss anticipatory tax, only the US withholding.</p><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>3. Recovering the 15%: the lump-sum tax credit (DA-1)</h2><p>The treaty provides that the 15% withheld in the US is credited against your Swiss tax. This is done through the <strong>lump-sum tax credit</strong>, claimed via the <strong>DA-1 form</strong> attached to your return. Switzerland credits the 15% already paid abroad against the Swiss tax due on that income.</p><p>Two practical points: a <strong>minimum of CHF 100</strong> per year of non-recoverable foreign withholding is required to obtain the credit; and Swiss banks provide a <strong>tax statement</strong> that pre-computes the DA-1 amounts. For US securities, an <strong>additional US tax retention</strong> sometimes applied is itself refunded in Switzerland via the return. In the end, with a correct W-8BEN and DA-1, you only bear the Swiss income tax.</p><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>What to DO</h2><div style='background:#F0FDF9;border:1px solid #10B981;border-radius:8px;padding:12px 16px;margin:12px 0'><ul><li><strong>File the W-8BEN</strong> with your bank to move from 30% to 15%, and renew it every three years.</li><li><strong>Declare the gross dividend</strong> and your securities in the statement of securities.</li><li><strong>Complete the DA-1 form</strong> to recover the 15% via the lump-sum credit.</li><li><strong>Keep the bank tax statement</strong>, which justifies and pre-fills your figures.</li><li><strong>Group your foreign securities</strong> to exceed the CHF 100 threshold.</li></ul></div><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>What NOT to do</h2><div style='background:#FEF2F2;border:1px solid #FCA5A5;border-radius:8px;padding:12px 16px;margin:12px 0'><ul><li><strong>Forget the W-8BEN.</strong> Result: 30% withheld, only 15% recoverable in Switzerland; the other half can only be reclaimed from the US IRS, a heavy and rarely worthwhile process.</li><li><strong>Fail to declare the dividend.</strong> That is tax evasion (back taxes, fines, interest), and you lose the credit.</li><li><strong>Assume the 35% anticipatory tax applies</strong> or will be refunded: it does not exist on foreign securities.</li><li><strong>Ignore US estate tax.</strong> Directly held US shares are US-situated assets: on the death of a non-resident, the portion above roughly <strong>USD 60,000</strong> may be taxed up to 40%. The CH-US estate tax treaty mitigates this, but the exposure is real on large portfolios.</li><li><strong>Hold US ETFs without considering the fund's domicile.</strong> An <strong>Ireland-domiciled ETF</strong> (UCITS) is often more efficient for a Swiss investor in US equities: 15% at fund level and, crucially, no US estate tax exposure.</li></ul></div><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>A worked example</h2><p>Gross dividend: USD 1,000. With a W-8BEN, the US withholds USD 150 (15%), you receive USD 850. In Switzerland you declare USD 1,000; taxed at your rate (say 30%), i.e. USD 300 of theoretical Swiss tax. Thanks to the DA-1, you credit the USD 150 already paid, reducing the Swiss tax to USD 150. Total borne: USD 300, exactly your Swiss tax. Without a W-8BEN, USD 300 would have been withheld in the US, of which 150 lost.</p><h2 style='color:#0D735E;font-size:22px;margin-top:28px'>In short</h2><p>A US dividend is not double-taxed if you follow the mechanics: W-8BEN for 15%, declare the gross amount, and DA-1 to recover the 15%. The real traps are not the rate, but forgetting the form, not declaring, and US estate tax on directly held securities.</p><p style='background:#F0FDF9;border:1px solid #10B981;border-radius:8px;padding:14px 16px;margin-top:22px'>At <strong>NeoFidu</strong>, we complete the statement of securities and the DA-1 form, check your foreign withholdings and optimise the structure of your investments (fund domicile, estate-tax exposure).</p><p style='font-size:13px;color:#6B7280;font-style:italic;margin-top:20px'>General information, not personalised tax advice. Rates and practices change according to your situation.</p></div>",
    category: "fiscalite",
    date: "2026-09-10",
    readTime: 8,
    keywords: ["dividende action américaine", "W-8BEN", "DA-1", "imputation forfaitaire", "impôt anticipé", "US estate tax", "fiscalité titres Suisse", "convention Suisse USA"],
  },
  {
    id: "109",
...
<p>Point important sur le <strong>moment</strong> du retrait. Si vous demandez le versement en capital alors que vous êtes déjà domicilié au Canada, la Suisse prélève de toute façon son impôt à la source sur la prestation (elle vous traite comme non-résident). Mais le Canada, votre pays de résidence, impose en principe votre revenu mondial : la prestation en capital y est en règle générale imposable comme revenu. Vous risquez donc une double charge, que la convention corrige, soit par un crédit d'impôt au Canada pour l'impôt suisse déjà payé, soit par le remboursement de l'impôt à la source suisse. Comme la facture peut être très différente selon que vous retirez avant ou après votre installation au Canada, il vaut vraiment la peine d'analyser le moment du retrait avant de le déclencher.</p>
...
<p><em>This article is for information only and does not replace personalised advice. Tax rules vary by canton and by your situation. Contact NeoFidu for an analysis tailored to your project.</em></p>`,
  ...
  },
   {
    ...
    title: "Initiative des 12% dans le canton de Vaud : ce que la baisse d'impôts changerait pour vous",
    titleEn: "Vaud's 12% initiative: what the tax cut would change for you",
...
<p><em>This article is provided for information only and is neither a political stance nor individualised tax advice. The amounts cited are simplified illustrations and vary by municipality and situation. Information current as of 16 August 2026, subject to change before the vote. Sources: RTS, 24heures.</em></p>`,
  ...
  },
  {
    ...
    title: "Raison individuelle ou Sàrl : quand et à quel chiffre d'affaires créer sa structure ?",
...

  {
    ...
    title: "Fin de l'anonymat crypto : la Suisse échange vos données avec 74 pays dès 2026",
...
<p style="color:#64748b;font-size:0.9em;"><em>Cet article est fourni à titre informatif et ne constitue pas un conseil fiscal individualisé.</em></p>`,
    ...
    date: "2026-06-12",
    readTime: 13,
    keywords: ["échange automatique crypto suisse", "CARF Suisse", "déclarer crypto 2026", "fiscalité bitcoin suisse", "AEOI crypto", "dénonciation spontanée", "impôt cryptomonnaie suisse"],
...
<p>Envie d'optimiser votre épargne et vos impôts ? <strong><a href="/demande">Déposez votre demande en ligne →</a></strong></p>`,
  ...
  {
    id: "30",
    slug: "independant-suisse-retraite-prevoyance",
    ...
    keywords: [
      ...
      "2ème pilier facultatif indépendant",
      "self employed retirement switzerland",
      "cotisation AVS indépendant",
      "retraite freelance suisse",
      "investir retraite indépendant",
...
<p>Voici un guide complet pour comprendre vos options et agir intelligemment.</p>
 
<br/>
 
<h3><strong>Le problème : une retraite à trou</strong></h3>
 
<br/>
 
<p>Le système suisse de prévoyance repose sur <strong>3 piliers</strong> :</p>
...
<p>Faites le calcul : c'est un écart de plusieurs centaines de milliers de francs sur une vie. Et plus vous attendez, plus le trou se creuse.</p>
...
<p>En tant qu'indépendant, vous êtes <strong>obligé de cotiser à l'AVS</strong>. Contrairement au salarié qui partage la cotisation 50/50 avec son employeur, vous payez l'intégralité vous-même.</p>
...
<p>Ce qu'il faut retenir : chaque année sans cotisation AVS crée une <strong>lacune</strong> qui réduit définitivement votre rente future. Une année manquante = environ <strong>2,3 % de rente en moins</strong>, à vie. Donc même si vos revenus sont bas au début, payez au moins le minimum.</p>
 
<br/>
 
<p>👉 <strong>Action :</strong> Inscrivez-vous auprès de la <a href="https://www.caisseavsvaud.ch">caisse AVS de votre canton</a> dès le début de votre activité. Gardez de côté 10 % de vos revenus nets pour les cotisations.</p>
...
<p>C'est ici que ça devient intéressant. En tant qu'indépendant <strong>sans caisse de pension (2ème pilier)</strong>, vous pouvez verser jusqu'à <strong>20 % de votre revenu net</strong> dans un pilier 3a, avec un plafond de <strong>36'288 CHF par an</strong> (2026).</p>
 
<br/>
 
<p>Relisez ce chiffre. Un salarié est limité à 7'258 CHF. Vous, vous pouvez mettre <strong>cinq fois plus</strong>. C'est un avantage énorme.</p>
 
<br/>
 
<p>Et chaque franc versé est <strong>intégralement déductible</strong> de votre revenu imposable. Si vous versez 30'000 CHF dans votre 3a et que votre taux marginal est de 35 %, vous économisez <strong>10'500 CHF d'impôts</strong>. Cette année. Tout de suite.</p>
 
<br/>
 
<p>Deux stratégies selon votre profil :</p>
 
<br/>
 
<ul style="margin-left:20px;margin-bottom:16px">
<li style="margin-bottom:8px">📊 <strong>Horizon long (10+ ans avant la retraite) :</strong> Choisissez un 3a en titres (actions/ETF). Des plateformes comme Finpension, VIAC ou Frankly proposent des solutions à frais réduits avec une exposition actions jusqu'à 99 %. Sur 20 ans, la différence avec un compte 3a classique peut représenter <strong>plus de 100'000 CHF</strong>.</li>
<li style="margin-bottom:8px">🏦 <strong>Horizon court (< 5 ans) :</strong> Restez sur un compte 3a bancaire classique pour la sécurité du capital.</li>
</ul>
 
<br/>
 
<p><strong>Nouveauté 2026 :</strong> Vous pouvez désormais effectuer des <strong>versements rétroactifs</strong> pour les années où vous n'avez pas cotisé le maximum (à partir des lacunes de 2025). C'est une opportunité en or pour rattraper le temps perdu.</p>
 
<br/>
 
<p>👉 <strong>Action :</strong> Ouvrez plusieurs comptes 3a (jusqu'à 5 est généralement recommandé) pour pouvoir les retirer de manière échelonnée à la retraite et réduire l'impôt sur le retrait.</p>
...
<p>En tant qu'indépendant, le 2ème pilier n'est pas obligatoire. Mais vous pouvez y adhérer <strong>volontairement</strong>. Trois options s'offrent à vous :</p>
 
<br/>
 
<ul style="margin-left:20px;margin-bottom:16px">
<li style="margin-bottom:8px">🔹 <strong>Rejoindre la caisse de pension de votre association professionnelle</strong> (si elle en a une)</li>
<li style="margin-bottom:8px">🔹 <strong>S'affilier à une fondation de libre passage</strong> qui accepte les indépendants</li>
<li style="margin-bottom:8px">🔹 <strong>S'assurer auprès de l'institution supplétive LPP</strong> (la fondation qui accepte tout le monde)</li>
</ul>
 
<br/>
 
<p>Les cotisations au 2ème pilier sont aussi <strong>déductibles fiscalement</strong>. Mais attention : contrairement au 3a, le 2ème pilier implique des frais de gestion, une rente de conversion qui baisse, et moins de flexibilité.</p>
 
<br/>
 
<p><strong>Alors, 2ème pilier ou pas ?</strong></p>
 
<br/>
 
<p>La question divise les experts. Voici le résumé pragmatique :</p>
 
<br/>
 
<ul style="margin-left:20px;margin-bottom:16px">
<li style="margin-bottom:8px">✅ <strong>Oui au 2ème pilier si :</strong> Vous avez des revenus élevés et stables, vous voulez une couverture décès/invalidité (que le 3a ne couvre pas bien), ou vous avez déjà maximisé votre 3a.</li>
<li style="margin-bottom:8px">❌ <strong>Non si :</strong> Vos revenus sont irréguliers, vous préférez la flexibilité, ou vous investissez déjà efficacement par vous-même. Le 3a à 36'288 CHF + des placements libres peuvent être plus performants qu'un 2ème pilier coûteux.</li>
</ul>
 
<br/>
 
<p>👉 <strong>Action :</strong> Demandez un devis à 2-3 caisses de pension pour indépendants. Comparez les frais, le taux de conversion, et les prestations risque (invalidité/décès). Et faites le calcul avec votre fiduciaire.</p>
...
<p>Une fois l'AVS payée et le 3a maximisé, que faire du reste ? Si vous avez la discipline, vous pouvez construire votre propre prévoyance via des <strong>investissements libres</strong>.</p>
 
<br/>
 
<p>L'avantage majeur en Suisse : les <strong>gains en capital sont exonérés d'impôts</strong> pour les investisseurs privés. Vous achetez un ETF à 100 CHF, il monte à 200 CHF, vous vendez : zéro impôt sur les 100 CHF de gain. C'est un avantage fiscal unique au monde (ou presque).</p>
 
<br/>
 
<p>Stratégie simple et efficace :</p>
 
<br/>
 
<ul style="margin-left:20px;margin-bottom:16px">
<li style="margin-bottom:8px">📈 <strong>ETF mondial diversifié</strong> (type MSCI World ou FTSE All-World) : un seul produit, des milliers d'entreprises, des frais minimes (0,1-0,2 % par an)</li>
<li style="margin-bottom:8px">🔄 <strong>Investissement régulier</strong> (DCA - Dollar Cost Averaging) : versez un montant fixe chaque mois, quel que soit le marché. Ça lisse les fluctuations.</li>
<li style="margin-bottom:8px">⏳ <strong>Patience :</strong> Ne touchez pas à cet argent. Sur 20-30 ans, un rendement moyen de 7 % par an transforme 1'000 CHF/mois en plus de <strong>800'000 CHF</strong>.</li>
</ul>
 
<br/>
 
<p>Courtiers disponibles en Suisse : Swissquote, Interactive Brokers (le moins cher), Yuh, ou Neon Invest pour les débutants.</p>
 
<br/>
 
<p>👉 <strong>Action :</strong> Ouvrez un compte de courtage. Mettez en place un virement automatique mensuel. Investissez dans un ETF diversifié. Et oubliez-le pendant 20 ans.</p>
...
<p>Un sujet que personne n'aime aborder, mais qui est <strong>critique</strong> pour les indépendants. Si vous tombez malade ou avez un accident grave, qui paie ?</p>
 
<br/>
 
<p>Sans 2ème pilier, votre couverture est minimale :</p>
...
<p>Solutions indispensables :</p>
 
<br/>
 
<ul style="margin-left:20px;margin-bottom:16px">
<li style="margin-bottom:8px">✅ <strong>Assurance perte de gain maladie :</strong> Couvre votre revenu si vous ne pouvez plus travailler. Choisissez un délai d'attente de 30 ou 60 jours pour réduire la prime.</li>
<li style="margin-bottom:8px">✅ <strong>Assurance accidents (LAA) :</strong> Obligatoire pour les salariés, facultative pour les indépendants. Fortement recommandée.</li>
<li style="margin-bottom:8px">✅ <strong>Assurance vie risque pur :</strong> Si vous avez une famille, une assurance décès (pas une assurance vie mixte) garantit un capital à vos proches. Peu coûteuse.</li>
</ul>
 
<br/>
 
<p>👉 <strong>Action :</strong> Faites le point sur vos assurances. Une perte de gain maladie est non négociable quand on est indépendant.</p>
...
<h3><strong>Le plan d'action concret</strong></h3>
 
<br/>
 
<p>Voici exactement ce que vous devriez mettre en place, dans l'ordre :</p>
 
<br/>
 
<ol style="margin-left:20px;margin-bottom:16px">
<li style="margin-bottom:8px"><strong>AVS :</strong> Vérifiez que vous êtes inscrit et que vos cotisations sont à jour. Demandez un extrait de compte AVS.</li>
<li style="margin-bottom:8px"><strong>Assurances risque :</strong> Souscrivez une perte de gain maladie et une LAA si ce n'est pas fait.</li>
<li style="margin-bottom:8px"><strong>3ème pilier 3a :</strong> Ouvrez un (ou plusieurs) compte 3a et versez le maximum chaque année. En titres si votre horizon est long.</li>
<li style="margin-bottom:8px"><strong>2ème pilier :</strong> Évaluez si l'adhésion volontaire fait sens pour votre situation spécifique.</li>
<li style="margin-bottom:8px"><strong>Placements libres :</strong> Investissez le surplus dans un portefeuille ETF diversifié.</li>
<li style="margin-bottom:8px"><strong>Réévaluez chaque année :</strong> Votre revenu change ? Ajustez vos cotisations et vos investissements.</li>
</ol>
 
<br/>
 
<h3><strong>Ce que ça donne concrètement</strong></h3>
 
<br/>
 
<p>Prenons l'exemple de Sarah, 35 ans, graphiste indépendante à Lausanne, revenu net de 90'000 CHF :</p>
 
<br/>
 
<ul style="margin-left:20px;margin-bottom:16px">
<li style="margin-bottom:8px">🏛️ <strong>AVS :</strong> ~9'000 CHF/an de cotisations → rente de ~2'450 CHF/mois à la retraite</li>
<li style="margin-bottom:8px">💰 <strong>3a maximisé :</strong> 18'000 CHF/an (20 % de 90'000) en 3a titres → à 7 % de rendement moyen, ça donne environ <strong>1'350'000 CHF à 65 ans</strong></li>
<li style="margin-bottom:8px">📈 <strong>ETF libres :</strong> 500 CHF/mois en plus → environ <strong>475'000 CHF supplémentaires</strong></li>
<li style="margin-bottom:8px">🧾 <strong>Économies fiscales :</strong> ~6'300 CHF/an grâce à la déduction du 3a</li>
</ul>
 
<br/>
 
<p>Total estimé à la retraite : <strong>AVS + ~1.8 million de capital</strong>. Sans compter les économies fiscales cumulées de près de <strong>190'000 CHF</strong> sur 30 ans. Pas mal pour quelqu'un qui "n'a pas de caisse de pension".</p>
 
<br/>
 
<p>Comparez avec le scénario « je ne fais rien » : AVS seule = 2'450 CHF/mois. La différence est vertigineuse.</p>
...
<p>Chez <strong>NeoFidu</strong>, nous accompagnons de nombreux indépendants dans leur déclaration d'impôts et leur stratégie de prévoyance. Nous vérifions que vos déductions sont optimisées, que vos cotisations AVS sont correctes, et que vous ne laissez pas d'argent sur la table.</p>
 
<br/>
 
<p>Indépendant et besoin d'y voir clair ? <strong><a href="/demande">Déposez votre demande en ligne →</a></strong></p>`,
    category: "fiscalite",
    date: "2026-04-21",
    readTime: 12,
  },   
...
{
    id: "32",
    slug: "votation-14-juin-2026-pme-independants-ce-qui-change",
    image: "https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=800&auto=format&fit=crop&q=60",
    title: "Votation du 14 juin : ce qui changerait pour les PME et indépendants romands",
    titleEn: "June 14 vote: what would change for SMEs and self-employed in French-speaking Switzerland",
    excerpt: "Le 14 juin 2026, la Suisse vote sur l'initiative « Pas de Suisse à 10 millions ! ». Recrutement, salaires, accords bilatéraux : tour d'horizon des conséquences concrètes pour les entrepreneurs romands.",
    excerptEn: "On June 14, 2026, Switzerland votes on the 'No Switzerland at 10 million!' initiative. Recruitment, wages, bilateral agreements: overview of concrete consequences for entrepreneurs.",
    keywords: ["votation 14 juin 2026", "pas de suisse à 10 millions", "impact PME", "pénurie main oeuvre suisse", "accords bilatéraux", "indépendant suisse", "charges sociales employeur 2026", "initiative immigration", "libre circulation personnes", "recrutement PME romande"],
    category: "actualites",
    date: "2026-04-23",
    readTime: 8,
...
<br/>
<p>L'initiative demande que la population résidante permanente de la Suisse ne dépasse pas <strong>10 millions d'habitants avant 2050</strong>. Si le seuil de 9,5 millions est franchi, le Conseil fédéral devrait prendre des mesures pour freiner la croissance démographique, notamment en matière d'asile et de regroupement familial.</p>
<br/>
<p>En dernier recours, l'initiative prévoit la dénonciation de l'Accord sur la libre circulation des personnes (ALCP) avec l'Union européenne. En raison de la <strong>clause guillotine</strong> des Bilatérales I, cela pourrait entraîner la caducité de six autres accords sectoriels (obstacles techniques au commerce, marchés publics, transport aérien, transport terrestre, agriculture, recherche).</p>
<br/>
<h3><strong>Les arguments des deux camps</strong></h3>
<br/>
<div style="background: #f0fdf4; padding: 20px; border-radius: 8px; margin: 16px 0; border-left: 4px solid #22c55e;">
<p style="margin: 0 0 8px 0; font-weight: 600;">Les partisans de l'initiative avancent que :</p>
<ul style="margin-left:20px;margin-bottom:0">
<li style="margin-bottom:6px">L'immigration nette de plus de 80'000 personnes par an aggrave la pénurie de logements et la hausse des loyers</li>
<li style="margin-bottom:6px">La croissance démographique met sous pression les infrastructures (routes, trains, hôpitaux)</li>
<li style="margin-bottom:6px">Un plafond démographique forcerait une politique migratoire plus sélective et mieux maîtrisée</li>
</ul>
</div>
<br/>
<div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 16px 0; border-left: 4px solid #f59e0b;">
<p style="margin: 0 0 8px 0; font-weight: 600;">Les opposants répondent que :</p>
<ul style="margin-left:20px;margin-bottom:0">
<li style="margin-bottom:6px">La fin de la libre circulation menacerait l'ensemble des accords bilatéraux I</li>
<li style="margin-bottom:6px">La pénurie de main-d'œuvre, déjà réelle, s'aggraverait fortement dans de nombreux secteurs</li>
<li style="margin-bottom:6px">L'économie suisse perdrait en compétitivité face à ses voisins européens</li>
</ul>
</div>
<br/>
<h3><strong>Le marché du travail suisse : état des lieux</strong></h3>
<br/>
<p>Indépendamment de la votation, le marché du travail suisse fait face à des tensions structurelles qu'il est utile de comprendre si vous dirigez une entreprise ou si vous êtes indépendant.</p>
<br/>
<p>Selon les études du SECO et de l'Adecco Group, <strong>plus de 85'000 postes</strong> sont actuellement ouverts en Suisse. Un travailleur sur quatre approche l'âge de la retraite, et les départs en retraite dépassent déjà les nouvelles entrées sur le marché du travail.</p>
<br/>
<p>Les projections anticipent un déficit pouvant atteindre <strong>460'000 équivalents plein temps d'ici 2035</strong> si l'immigration devait être fortement réduite. Les secteurs les plus exposés :</p>
<br/>
<table style="width:100%;border-collapse:collapse;margin-bottom:16px"><thead><tr style="background:#f1f5f9"><th style="border:1px solid #e2e8f0;padding:10px 14px;text-align:left">Secteur</th><th style="border:1px solid #e2e8f0;padding:10px 14px;text-align:left">Situation actuelle</th></tr></thead><tbody>
<tr><td style="border:1px solid #e2e8f0;padding:10px 14px">Santé</td><td style="border:1px solid #e2e8f0;padding:10px 14px">1 médecin sur 4 a plus de 60 ans, forte dépendance au personnel étranger</td></tr>
<tr style="background:#f9fafb"><td style="border:1px solid #e2e8f0;padding:10px 14px">Construction</td><td style="border:1px solid #e2e8f0;padding:10px 14px">Part importante de travailleurs frontaliers et détachés</td></tr>
<tr><td style="border:1px solid #e2e8f0;padding:10px 14px">Restauration / hôtellerie</td><td style="border:1px solid #e2e8f0;padding:10px 14px">Difficulté chronique à recruter, turnover élevé</td></tr>
<tr style="background:#f9fafb"><td style="border:1px solid #e2e8f0;padding:10px 14px">Technologies / conseil</td><td style="border:1px solid #e2e8f0;padding:10px 14px">Concurrence internationale pour les talents qualifiés</td></tr>
...
<br/>
<h3><strong>Ce que coûte réellement un employé en Suisse en 2026</strong></h3>
<br/>
<p>Puisque cette votation touche directement au marché du travail, c'est l'occasion de rappeler les charges sociales employeur en vigueur :</p>
<br/>
<table style="width:100%;border-collapse:collapse;margin-bottom:16px"><thead><tr style="background:#f1f5f9"><th style="border:1px solid #e2e8f0;padding:10px 14px;text-align:left">Charge</th><th style="border:1px solid #e2e8f0;padding:10px 14px;text-align:left">Part employeur</th></tr></thead><tbody>
<tr><td style="border:1px solid #e2e8f0;padding:10px 14px"><strong>AVS / AI / APG</strong></td><td style="border:1px solid #e2e8f0;padding:10px 14px">5,3% du salaire brut</td></tr>
<tr style="background:#f9fafb"><td style="border:1px solid #e2e8f0;padding:10px 14px"><strong>LPP (2ème pilier)</strong></td><td style="border:1px solid #e2e8f0;padding:10px 14px">Variable selon le plan, généralement 50/50</td></tr>
<tr><td style="border:1px solid #e2e8f0;padding:10px 14px"><strong>LAA (accidents prof.)</strong></td><td style="border:1px solid #e2e8f0;padding:10px 14px">Entièrement à charge de l'employeur</td></tr>
<tr style="background:#f9fafb"><td style="border:1px solid #e2e8f0;padding:10px 14px"><strong>AC (assurance chômage)</strong></td><td style="border:1px solid #e2e8f0;padding:10px 14px">1,1%</td></tr>
<tr><td style="border:1px solid #e2e8f0;padding:10px 14px"><strong>Allocations familiales</strong></td><td style="border:1px solid #e2e8f0;padding:10px 14px">Entièrement employeur (variable par canton)</td></tr>
</tbody></table>
<br/>
<div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 16px 0;">
...
<br/>
<h3><strong>Ce que nous recommandons</strong></h3>
<br/>
...
<p style="margin: 0 0 12px 0; font-weight: 600; font-size: 18px;">Vous êtes indépendant ou dirigez une PME en Suisse romande ?</p>
<p style="margin: 0 0 16px 0; color: #666;">NeoFidu vous accompagne dans la création de votre entreprise, la gestion de vos charges sociales et l'optimisation de votre fiscalité.</p>
<a href="/demande" style="display: inline-block; background: #10b981; color: white; padding: 14px 32px; border-radius: 9999px; text-decoration: none; font-weight: 600;">Contactez-nous</a>
</div>
<br/>

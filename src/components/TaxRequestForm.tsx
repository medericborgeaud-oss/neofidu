      ...
      <Card className="p-6 md:p-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateForm("taxpayerNumber", e.target.value)}
                    className="rounded-xl border-amber-300"
                  />
                  <p className="text-xs text-muted-foreground mt-1">
                    Format: chiffres, points ou tirets
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2">
                    Code déclaration <span className="text-red-500">*</span>
                  </label>
                  <Input
        ...
        {currentStep === 4 && (
          <div>
            ...
            {/* Statut d'emploi (pour non-indépendants) */}
            ...
            <div className="mb-6">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) => updateForm("hasChildren", e.target.checked)}
                  className="w-5 h-5 rounded border-2 border-gray-300 text-primary focus:ring-primary"
                />
                <span>J'ai des enfants à charge</span>
              </label>
                ...
                <div className="mt-4 ml-8 space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => updateForm("childrenCount", Number.parseInt(e.target.value) || 0)}
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={formData.hasGuardCosts}
                      onChange={(e) => updateForm("hasGuardCosts", e.target.checked)}
                      className="w-5 h-5 rounded border-2 border-gray-300 text-primary focus:ring-primary"
                    />
                    <span>J'ai des frais de garde (crèche, UAPE, cantine, etc.)</span>
                  </label>
                </div>
              )}
            </div>
            ...
            <div className="mb-6">
              ...
              {formData.hasStocks && (
                <div className="mt-4 ml-8">
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">
                    Supplément de CHF 20 si plus de 5 positions
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="mb-6">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) => updateForm("hasProperty", e.target.checked)}
                  className="w-5 h-5 rounded border-2 border-gray-300 text-primary focus:ring-primary"
                />
                <span>Je suis propriétaire d'un bien immobilier</span>
              </label>
            </div>
              ...
              <div className="space-y-6 ml-8">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateForm("propertyCount", Number.parseInt(e.target.value) || 1)}
                    className="w-24 rounded-xl"
                  />
                  <p className="text-xs text-muted-foreground mt-1">
                    Supplément de CHF 50 par bien
                  </p>
                </div>
                ...
                <div>
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      onChange={(e) => updateForm("hasMortgage", e.target.checked)}
                      className="w-5 h-5 rounded border-2 border-gray-300 text-primary focus:ring-primary"
                    />
                    <span>J'ai une hypothèque</span>
                  </label>
                </div>
                ...
                <div>
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={formData.hasRenovations}
                      onChange={(e) => updateForm("hasRenovations", e.target.checked)}
                      className="w-5 h-5 rounded border-2 border-gray-300 text-primary focus:ring-primary"
                    />
                    <span>J'ai effectué des travaux d'entretien ou de rénovation</span>
                  </label>
                </div>
              </div>
            )}
            ...
            <div className="mb-8">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) => updateForm("wantsReview", e.target.checked)}
                  className="w-5 h-5 rounded border-2 border-gray-300 text-primary focus:ring-primary"
                />
                <div>
                  <span className="font-medium">Consultation téléphonique</span>
                  <span className="text-sm text-muted-foreground ml-2">(+CHF 30)</span>
                  <p className="text-sm text-muted-foreground">
                    Un conseiller vous appellera pour revoir ensemble votre déclaration avant envoi.
                  </p>
                </div>
              </label>
            </div>
            ...
            <div className="mt-8 p-6 bg-primary/5 rounded-2xl border border-primary/20">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span>Déclaration {formData.clientType === "couple" ? "couple" : formData.clientType === "independent" ? "indépendant" : "individuelle"}</span>
                  <span>CHF {formData.clientType === "couple" ? "70" : formData.clientType === "independent" ? "90" : "50"}.-</span>
                </div>
                ...
                {formData.hasProperty && (
                  <div className="flex justify-between">
                    <span>{formData.propertyCount} bien(s) immobilier(s)</span>
                    <span>CHF {50 * formData.propertyCount}.-</span>
                  </div>
                )}
                {formData.hasStocks && formData.stocksCount > 5 && (
                  <div className="flex justify-between">

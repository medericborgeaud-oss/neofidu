...
export function AccountingRequestForm() {
  ...
  const t = {
    ...
    quoteNote: isEnglish
      ? "We will send you a detailed quote within 24 hours. Payment will only be requested after your approval."
      : "Nous vous enverrons un devis détaillé sous 24h. Le paiement ne sera demandé qu'après validation de votre part.",

    // Success
    successTitle: isEnglish ? "Request sent successfully!" : "Demande envoyée avec succès !",
    successMessage: isEnglish
      ? "Thank you for your interest. An advisor will analyze your file and contact you within 24 hours with a personalized quote."
      : "Merci pour votre intérêt. Un conseiller analysera votre dossier et vous contactera sous 24h avec un devis personnalisé.",

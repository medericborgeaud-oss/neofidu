...
const MAX_3A_INDEPENDENT = 36288; // Plafond 2026 (20% du revenu net)
      ...
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            {t("simulators.pillar3a.title")}
          </CardTitle>
          <p className="text-sm text-muted-foreground mt-2">
            {t("simulators.pillar3a.subtitle")}
          </p>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="currentAge">{t("simulators.pillar3a.currentAge")}</Label>
                <Input
                  id="currentAge"
                  type="number"
                  min="18"
              ...
              <div>
                <Label htmlFor="retirementAge">{t("simulators.pillar3a.retirementAge")}</Label>
                <Input
                  id="retirementAge"
                  type="number"
                  min="58"
            ...
            <div>
              <Label htmlFor="income3a">{t("simulators.pillar3a.grossIncome")}</Label>
            ...
            <div>
              <Label htmlFor="canton3a">{t("simulators.common.canton")}</Label>
              <select
                id="canton3a"
            ...
            <div>
              <Label>{t("simulators.pillar3a.professionalStatus")}</Label>
              <div className="grid grid-cols-2 gap-3 mt-2">
                ...
                >
                  ...
                  <span className="text-sm font-medium">{t("simulators.pillar3a.employee")}</span>
                  <p className="text-xs text-muted-foreground mt-1">{t("simulators.pillar3a.maxEmployee")}</p>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="text-sm font-medium">{t("simulators.pillar3a.selfEmployed")}</span>
                  <p className="text-xs text-muted-foreground mt-1">{t("simulators.pillar3a.maxSelfEmployed")}</p>
                </button>
              </div>
            </div>

            <div>
              <Label htmlFor="contribution">{t("simulators.pillar3a.annualContribution")}</Label>
              <div className="relative mt-2">
                <Input
                  id="contribution"
                  type="number"
            ...
            <div>
              <Label htmlFor="return">{t("simulators.pillar3a.expectedReturn")}</Label>
              <div className="relative mt-2">
                <Input
                  id="return"
                  type="number"
              ...
              <div className="flex gap-2 mt-2">
                {[
                  { label: t("simulators.pillar3a.conservative"), value: "1.5" },
                  { label: t("simulators.pillar3a.balanced"), value: "2.5" },
                  { label: t("simulators.pillar3a.dynamic"), value: "4.0" },
                ].map((opt) => (
                  <button
                    key={opt.label}
                    type="button"
            ...
            <Button type="submit" className="w-full h-12">
              {t("simulators.pillar3a.calculateSavings")}
      ...
      <Card className="bg-gradient-to-br from-emerald-600 to-teal-700 text-white overflow-hidden relative">
        ...
        <CardContent className="p-8 relative">
          <div className="text-center mb-6">
            <p className="text-white/80 text-sm mb-2">{t("simulators.pillar3a.projectedCapital")}</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div className="bg-white/10 rounded-xl p-4">
              ...
              <p className="text-white/70 text-xs">{t("simulators.pillar3a.contributions")}</p>
            ...
            <div className="bg-white/10 rounded-xl p-4">
              ...
              <p className="text-white/70 text-xs">{t("simulators.pillar3a.interest")}</p>
              <p className="font-bold">{formatCurrency(result.projectedInterest)}</p>
            </div>
            <div className="bg-white/10 rounded-xl p-4">
              <PiggyBank className="w-5 h-5 mx-auto mb-2 text-yellow-300" />
              <p className="text-white/70 text-xs">{t("simulators.pillar3a.taxSavingsShort")}</p>
            ...
            <div className="bg-white/10 rounded-xl p-4">
              ...
              <p className="text-white/70 text-xs">{t("simulators.pillar3a.duration")}</p>
              <p className="font-bold">{result.yearsToRetirement} {t("simulators.common.years")}</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <Card className="border-2 border-primary/20 bg-primary/5">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">{t("simulators.pillar3a.annualSavings")}</p>
                <p className="text-2xl font-bold text-primary">{formatCurrency(result.taxSavingsYear)}</p>
              </div>
            </div>
            <p className="text-sm text-muted-foreground mt-4">
              {t("simulators.pillar3a.immediateReturn")}{" "}
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">{t("simulators.pillar3a.totalReturn")}</p>
            ...
            <p className="text-sm text-muted-foreground mt-4">
              {t("simulators.pillar3a.compoundInterest")} {result.yearsToRetirement} {t("simulators.common.years")}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-lg">
            ...
            {t("simulators.pillar3a.projection")}
          </CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  <th className="text-left py-3 px-2">{t("simulators.common.year")}</th>
                  <th className="text-left py-3 px-2">{t("simulators.common.age")}</th>
                  <th className="text-right py-3 px-2">{t("simulators.pillar3a.cumulativeContributions")}</th>
                  <th className="text-right py-3 px-2">{t("simulators.pillar3a.interest")}</th>
                  <th className="text-right py-3 px-2">{t("simulators.pillar3a.capital")}</th>
                  <th className="text-right py-3 px-2">{t("simulators.pillar3a.taxSavingsShort")}</th>
                </tr>
              </thead>
              <tbody>
        ...
        <CardContent className="p-4">
          <div className="flex gap-3">
            ...
            <div className="text-sm text-blue-800">
              <p className="font-medium mb-1">{t("simulators.pillar3a.infoTitle")}</p>
              <ul className="space-y-1 text-blue-700">
                <li>• {t("simulators.pillar3a.info1")}</li>
                <li>• {t("simulators.pillar3a.info2")}</li>
                <li>• {t("simulators.pillar3a.info3")}</li>
              </ul>
            </div>
          </div>
        </CardContent>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <Link href="/demande">
          <Button size="lg" className="w-full sm:w-auto">
            {t("simulators.common.optimizeDeclaration")}

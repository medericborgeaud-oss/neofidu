...
const MAX_3A_EMPLOYEE = 7056;
const MAX_3A_INDEPENDENT = 35280;
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 mt-2">
                <button
                  type="button"
                  onClick={() => setFormData({ ...formData, isIndependent: false, contribution: "7056" })}
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Max. CHF 7'056</p>
                </button>
                <button
                  type="button"
                  onClick={() => setFormData({ ...formData, isIndependent: true, contribution: "35280" })}
                  className={`p-4 rounded-lg border-2 transition-all ${
                    formData.isIndependent ? "border-primary bg-primary/5" : "border-gray-200"
                  }`}
                >
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Max. CHF 35'280</p>
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative mt-2">
                <Input
                  id="contribution"
                  type="number"
                  max={formData.isIndependent ? 35280 : 7056}
              ...
              <div className="flex gap-2 mt-2">
                {[
                  { label: "50%", value: formData.isIndependent ? 17640 : 3528 },
                  { label: "Max", value: formData.isIndependent ? 35280 : 7056 },
                ].map((opt) => (
                  <button
                    key={opt.label}
                    type="button"

...
const simulators = [
  ...
  },
  {
    ...
    description: {
      fr: "Découvrez si vous pouvez demander une baisse de loyer selon le taux de référence.",
      en: "Find out if you can request a rent reduction based on the reference rate.",
    },

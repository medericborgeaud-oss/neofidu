...
const simulators = [
  {
    ...
    description: {
      fr: "Calculez vos impôts en 2 minutes. Les 26 cantons suisses.",
      en: "Calculate your taxes in 2 minutes. All 26 Swiss cantons.",
    },
  ...
  },
  {
    ...
    description: {
      fr: "Économie d'impôts et capital retraite. Jusqu'à 30% d'économie fiscale.",
      en: "Tax savings and retirement capital. Up to 30% tax savings.",
    },
  ...
  },
  {
    id: "gain-immobilier",
    icon: Building2,
    title: { fr: "Simulateur Gain Immobilier", en: "Property Gain Tax Calculator" },
    description: {
      fr: "Calculez l'impôt sur la plus-value lors de la vente de votre bien.",
      en: "Calculate capital gains tax when selling your property.",
    },

...
export function Pricing() {
  ...
  const priceNote = isEnglish
    ? "Tax services: prices incl. VAT (8.1%). Accounting & property management: prices excl. VAT. The exact price is displayed during your online simulation."
    : "Prestations fiscales : prix TTC (TVA 8.1% incluse). Comptabilité & gérance immobilière : prix HT. Le tarif exact s'affiche lors de votre simulation en ligne.";
  ...
  return (
    <section id="tarifs" className="py-20 md:py-32 bg-white content-auto">
      <div className="container mx-auto px-4">
        ...
        {/* Payment Methods Note - TWINT Requirement */}
        <div className="mt-8 flex flex-col items-center justify-center gap-4">
          ...
          <div className="flex items-center gap-4">
            {/* TWINT */}
            <div className="bg-white rounded-lg border px-4 py-2 flex items-center justify-center shadow-sm" title="TWINT">
              <span className="font-bold text-black text-sm">TWINT</span>
            </div>
            {/* Visa */}
            <div className="bg-white rounded-lg border px-4 py-2 flex items-center justify-center shadow-sm" title="Visa">
              <span className="font-bold text-blue-700 text-sm">VISA</span>
            </div>
            {/* Mastercard */}
            <div className="bg-white rounded-lg border px-4 py-2 flex items-center justify-center shadow-sm" title="Mastercard">

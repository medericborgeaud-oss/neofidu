...
export function Hero() {
  ...
  const subtitle = isEnglish
    ? "Submit your tax return request online. We handle everything else. Individuals, freelancers and companies across six Swiss Romand cantons."
    : "Déposez votre demande de déclaration d'impôts en ligne. Nous nous occupons du reste. Particuliers, indépendants et sociétés en Suisse romande.";
